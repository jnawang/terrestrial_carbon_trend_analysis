...
#
df_file_structure <- dataframe(source = c(), 
                              folder = c(), 
                              HHfile = c(), 
                              DDfile = c(),
                              YYfile = c())
...
for (i in 1:nrow(sites_long)) {
  ...
  if (sites_long$source[i] == "AmeriFlux_FLUXNET") {
    a_HH <- read.csv(files.unzip.Ameri[grepl(pattern=paste0(site_ID, "_FLUXNET_FULLSET_(HR|HH)"), files.unzip.Ameri)])
    a_YY <- read.csv(files.unzip.Ameri[grepl(pattern=paste0(site_ID, "_FLUXNET_FULLSET_YY"), files.unzip.Ameri)])
  } else if (sites_long$source[i] == "FLUXNET2020_ICOS") {
  ...
  } else if (sites_long$source[i] == "FLUXNET2015_ICOS") {
    a_HH <- read.csv(files.unzip.Europ2023[grepl(pattern=paste0(site_ID, "_FLUXNET_HH"), files.unzip.Europ2023)])
    a_YY <- read.csv(files.unzip.Europ2023[grepl(pattern=paste0(site_ID, "_FLUXNET_YY"), files.unzip.Europ2023)])
  }
  
  
  else if (sites_long$source[i] == "FLUXNET2020") {
    a_HH <- read.csv(files.unzip.Europ2020[grepl(pattern=paste0(site_ID, "_FLUXNET2015_FULLSET_HH"), files.unzip.FLUXNET2020)])
    a_YY <- read.csv(files.unzip.Europ2020[grepl(pattern=paste0(site_ID, "_FLUXNET2015_FULLSET_YY"), files.unzip.FLUXNET2020)])
  } else if (sites_long$source[i] == "FLUXNET2015") {
    a_HH <- read.csv(files.unzip.Europ2020[grepl(pattern=paste0(site_ID, "_FLUXNET2015_FULLSET_HH"), files.unzip.FLUXNET2015)])
    a_YY <- read.csv(files.unzip.Europ2020[grepl(pattern=paste0(site_ID, "_FLUXNET2015_FULLSET_YY"), files.unzip.FLUXNET2015)])
  } 
