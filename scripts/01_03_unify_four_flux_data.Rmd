...
df_file_structure <- data.frame(sources = c("AmeriFlux_FLUXNET", "AmeriFlux_BASE", 
                               ...
                               folders = c(files.unzip.Ameri, files.Ameri.ReddyProcGapFill, 
                                           files.unzip.FLUXNET2020_ICOS, files.unzip.FLUXNET2015_ICOS,
                                           files.unzip.FLUXNET2020, files.unzip.FLUXNET2015), 
...
for (i in 1:nrow(sites_long)) {
  ...
  print(site_ID)
  folder <- df_file_structure$folders[df_file_structure$sources == sites_long$source[i]]
