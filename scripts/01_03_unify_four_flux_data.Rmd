...
sites_long <- sites_long %>% filter(!site_ID %in% c('CA-TP1', 'US-Rpf', 'US-Me6', 'US-Myb', "CA-Ca2", "US-KLS", "US-NC1", "US-NC3", "US-Tw4", "US-SP2", "CL-SDP", "DE-Hzd"))
##
```
...
#  print(f.data.measured)
  ...
  if (!site_ID %in% c("BR-Sa1", "US-LL3", "US-LL1", "US-LL2", "GF-Guy", "CL-SDF")) {
...
#
sum(sites_long$category=='dry')
# we have 13 dry sites.
sum(sites_long$category=='wet')
# we have 16 wet sites.
sum(sites_long$category=='cold')
# we have 74 cold sites. 
