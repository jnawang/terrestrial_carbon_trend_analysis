...
## sites I should work on: [1] "BR-Ma2" "US-An3" "US-Aud" "US-Blo" "US-ChR" "US-Cwt" "US-Ha2" "US-IB2" "US-KL2" "US-KL3"
## [11] "US-KM2" "US-KM3" "US-KM4" "US-LA2" "US-MBP" "US-Me4" "US-NR3" "US-NR4" "US-Vcs" "US-Wrc"
...
#
#
FC_duration_thresh <- 9 * 365       # unit days
...
#
# sites to remove: "US-An3",  "US-LA2", "US-Me4", "US-Vcs" (large gaps year after year)
...
site_to_remove <- c("US-An3", "US-LA2", "US-Me4", "US-Vcs")       # this is actually calculated in the previous chunks
...
for (i in 1:nrow(sites_selected_BASE1)) {
  # "BR-Ma2" "US-Aud" "US-ChR" "US-Cwt" "US-Ha2" "US-IB2" "US-KL2" "US-KL3" "US-KM2" "US-KM3"
  # "US-KM4" "US-MBP" "US-NR3" "US-NR4"
  # i = 1
#  i = 12  # 12-13: US-Elm, US-Esm 1:nrow(sites_selected_BASE1)
  ...
  if (!name_site %in% c("US-Aud", "US-Blo", "US-ChR", "US-Cwt", "US-Ha2", "US-IB2", "US-KL2", "US-KL3", "US-KM2", "US-KM3", "US-KM4", "US-MBP", "US-NR3", "US-NR4")) {
    next
  }
