...
merge_gs_threshold <- 60    # two months
...
#  i = 2
  ...
  if (sum(!is.na(a_DD$GPP_DT_VUT_REF)) >= 5*365 & !site_ID %in% c("BR-Sa1", "US-NC2", "US-SP3", "US-WCr", "US-Ho1", "US-Ho2", "US-NC4")) {
...
```{r try to use daytime NEE}

# a simple function to generate years and coordinates
...
library(ncdf4)
#
nc_file <- nc_open("/Users/jw2946/Downloads/e85972292775e955f9a612c42e47685.nc")
#
