...
summary(lm(NEE_trend ~ Height + P_gs_t + SW_gs_t, data=data_cold_nonforest))  # R2 = 0.557 / 0.5752 # + IGBP_new
# (Intercept)  0.141098   0.059422   2.374  0.02718 * 
# Height      -0.011522   0.004504  -2.558  0.01832 * 
# P_gs_t      -0.331190   0.149073  -2.222  0.03743 * 
# SW_gs_t      0.527238   0.183009   2.881  0.00894 **


data_cold_DBF <- data %>% filter(category == "cold" & IGBP %in% c("DBF", "MF")) 
summary(lm(NEE_trend ~ LE_gs_t, data=data_cold_DBF))  # R2 = 0.1635 
...
summary(lm(NEE_trend ~ P_gs_t + Lgs_t, data=data_cold_ENF))  # R2 = 0.3429 
